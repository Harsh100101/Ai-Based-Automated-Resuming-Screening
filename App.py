...
def run():
    ...
    img = Image.open("./Logo/AI_UPS.png")
    ...
    if choice == "Normal User":
        ...
        if st.button("Login"):
            if ad_user == "root" and ad_password == "root":
                st.success("Welcome AI Upstarts ")
                # Display Data
...
## Pie chart for predicted field recommendations
                ...
                values_df.columns = ['Predicted_Field', 'count']
                fig = px.pie(values_df, names='Predicted_Field', values='count', title="Predicted Field according to the Skills")
                st.plotly_chart(fig)
...
### Pie chart for User's👨‍💻 Experienced Level
                ...
                values_df = values.reset_index()
                values_df.columns = ['User_level', 'count']
                fig = px.pie(values_df, names='User_level', values='count', title="Pie-Chart📈 for User's👨‍💻 Experienced Level")
                st.plotly_chart(fig)
